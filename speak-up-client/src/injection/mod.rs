...
pub mod linux;
#[cfg(target_os = "linux")]
pub use linux::LinuxTextInjector as DefaultTextInjector;

#[cfg(target_os = "macos")]
pub mod macos;
#[cfg(target_os = "macos")]
pub use macos::MacOSTextInjector as DefaultTextInjector;

#[cfg(target_os = "windows")]
pub mod windows;
#[cfg(target_os = "windows")]
pub use windows::WindowsTextInjector as DefaultTextInjector;
